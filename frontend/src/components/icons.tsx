...
export const MaleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
    <path fillRule="evenodd" d="M10 5.5a4.5 4.5 0 100 9 4.5 4.5 0 000-9zM10 3.5a6.5 6.5 0 100 13 6.5 6.5 0 000-13z" clipRule="evenodd" />
    <path d="M14.5 2a.75.75 0 01.75.75V5h2.25a.75.75 0 010 1.5H15.25v2.25a.75.75 0 01-1.5 0V6.5h-2.25a.75.75 0 010-1.5H13.75V2.75A.75.75 0 0114.5 2z" />
  </svg>
);
...
export const FemaleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
    <path fillRule="evenodd" d="M10 5.5a4.5 4.5 0 100 9 4.5 4.5 0 000-9zM10 3.5a6.5 6.5 0 100 13 6.5 6.5 0 000-13z" clipRule="evenodd" />
    <path d="M10.25 14.25a.75.75 0 010 1.5h-1a.75.75 0 010-1.5h.25V13h-1a.75.75 0 010-1.5h1v-1.25H9.5a.75.75 0 010-1.5h1a.75.75 0 010 1.5h-.25V13h1a.75.75 0 010 1.5h-1v1.25h.25z" />
  </svg>
);
